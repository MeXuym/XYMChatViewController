...
- (instancetype)init{
    ...
    self.modalBackgroundColor = [UIColor colorWithWhite:0 alpha:0];
...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated {
    ...
    {
        containerViewRect = contentView.bounds;
    }
    else
    {
        containerViewRect = CGRectInset(contentView.bounds, -padding, -padding);
    }
